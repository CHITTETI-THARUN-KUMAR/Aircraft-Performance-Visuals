...
SQL in Python: pandasql for SQL queries within Jupyter Notebooks

Visualization: Matplotlib, and Seaborn for dashboards and report generation.​
...
3. SQL Analytics (Using pandasql)
